...
public class LeatherArmor implements Armor {
    ...
    private final int BASE_BONUS_HP = 20;
    private final int BASE_BONUS_STRENGTH = 1;
    private final int BASE_BONUS_DEXTERITY = 3;
    private final int BASE_BONUS_INTELLIGENCE = 0;

    private final int ADDED_BONUS_HP_PER_LEVEL = 8;
    private final int ADDED_BONUS_STRENGTH_PER_LEVEL = 1;
    private final int ADDED_BONUS_DEXTERITY_PER_LEVEL = 2;
    ...
    public LeatherArmor(String name, int level, Slot slot) {
        this.name = name;
        this.level = level;
        this.slot = slot;
